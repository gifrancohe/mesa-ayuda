...
<main>
    <div class="container" style="margin-top: 20px;">
        <div class="row card s12 m12" style="padding: 15px;">
            <div>
                <h5 class="center-align teal-text text-lighten-1">Reporte de observaciones de requisitos sin solución total</h5>
            </div>
  ...
  <script>
    ...
    $(".enviar").click(function(e) {
        ...
        $.ajax({
            url: "../../controllers/ReporteController.php?observacion=1",
            type: "POST",
            data: datos
            ...
            if(response !== "null" && response.length !== 0) {
                ...
                data.map(item => {
                    tbody += "<tr><td>"+item['OBSERVACION']+"</td><td>"+item['FKREQ']+"</td><td>"+item['FECHA']+"</td><td>"+item['NOMBRE']+"</td></tr>"; 
                });

    ...
    <div class="container" style="margin-top: 20px;">
        <div class="row card s12 m12" style="padding: 15px;">
            <div style="display: flex; justify-content: space-between;">
                <a class="waves-effect waves-light btn" href="lista.php"><i class="material-icons left">list</i>Lista Áreas</a>
                <h5 class="center-align teal-text text-lighten-1">Área: <?= $area['NOMBRE'] ?></h5>
                <a class="waves-effect waves-light btn" href="editar.php?id=<?= $idarea;?>"><i class="material-icons right">edit</i>Editar Área</a>
            </div>

<?php 
    ...
    */
    ...
    $areas = $areaCtrl->lista();
?>
<main>
    <div class="container" style="margin-top: 20px;">
        <div class="row card s12 m12" style="padding: 15px;">
            <div>
                <h5 class="center-align teal-text text-lighten-1">Lista de Áreas</h5>
            </div>
            ...
            <div class="table-usuarios" id="tabla-usuarios">
                <a class="waves-effect waves-light btn" href="crear.php"><i class="material-icons right">add_circle</i>Crear Área</a>
                    ...
                    <tbody>
                        <?php foreach($areas as $key => $area):?>
                            <tr>
                                ...
                                <td><?= $area['LIDER'] ? utf8_encode($area['LIDER']) : 'Sin definir'; ?></td>
                                <td>
                                    <a href="<?= "ver.php?id=".$area['IDAREA'];?>"><i class="material-icons">visibility</i></a>
                                    <a href="<?= "editar.php?id=".$area['IDAREA'];?>"><i class="material-icons">edit</i></a> 
                                </td>
                            </tr>
                        <?php endforeach;?>
                    </tbody>
